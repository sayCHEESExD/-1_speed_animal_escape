...
export class LocalPlayer {
  ...
  constructor(collision: WorldCollision, animalSlot: number) {
    this.collision = collision;
    this.mount = new Mount(animalSlot);
  ...
  /** Show the animal the server says this player is riding. Cosmetic only. */
  setAnimalSlot(slot: number): void {
    this.mount.setAnimalSlot(slot);
  }
