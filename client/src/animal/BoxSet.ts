 ...
 *
 * Every animal in this game is built from boxes, which is what keeps the
 ...
 * moving part is what keeps that cheap at runtime too: a ten-animal lobby is
 ...
 * renders with a SINGLE `MeshLambertMaterial` and no per-animal uploads.
 */
export class BoxSet {
