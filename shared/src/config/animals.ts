...
export const ANIMALS: readonly AnimalDefinition[] = [
  ...
  // ---- The prestige tier --------------------------------------------------
  // Priced against the late course rather than against the dragon: stage 30
  // pays 5M Wins a clear, so the first of these costs two clears of the
  // hardest stage and the last is a long-term goal. Every one is the same
  // generic quadruped with a palette and features the builder already draws -
  // there is no new modelling code and no new mechanic behind any of them.
  // `moveBonus` keeps climbing gently, for the reason trails are gentle: speed
  // is already multiplied by level and rebirth, and a steep top rung would put
  // a player through the obby faster than its platforms can be read.
  {
    id: 'frostWolf',
    name: 'Frost Wolf',
    slot: 11,
    winsRequired: 10_000_000,
    speedPerStep: 2500,
    moveBonus: 2.25,
    jumpBonus: 1.32,
    scale: 1.08,
  ...
  },
  {
    ...
    features: ['wings', 'mane', 'tailTuft'],
  },
  {
    id: 'crystalUnicorn',
    name: 'Crystal Unicorn',
    slot: 14,
    winsRequired: 500_000_000,
    speedPerStep: 7500,
    moveBonus: 2.7,
    jumpBonus: 1.38,
    scale: 1.12,
    ...
    features: ['horn', 'wings', 'mane', 'tailTuft'],
  },
  {
    id: 'celestialDragon',
    name: 'Celestial Dragon',
    slot: 15,
    winsRequired: 1_500_000_000,
    speedPerStep: 10000,
    moveBonus: 2.85,
    jumpBonus: 1.4,
    scale: 1.16,
