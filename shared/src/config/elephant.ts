 ...
 * than authored separately - an elephant whose patrol range and whose floor
 ...
 *
 * The arena is deliberately huge; the elephant using slightly less of it than
 * the player does is what keeps a corner from becoming a safe spot AND keeps
 * the animal off the geometry.
 */
const INSET = 8;
