...
/** Noun half, drawn from the game's own animals and its verbs. */
const SECOND = [
  'Gallop', 'Hoof', 'Mane', 'Rider', 'Stag', 'Llama', 'Bolt', 'Dash',
  'Comet', 'Bounce', 'Trail', 'Sprint', 'Hopper', 'Racer', 'Charger', 'Zebra',
] as const;
